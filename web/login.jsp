...
<div class="container" style="width: 400px;">
    ...
    <form action="login" method="post">
        <div class="form-group">
            ...
            <input type="text" name="username" class="form-control" id="user" placeholder="Please enter your user name"/>
        </div>
        ...
        <div class="form-inline">
            ...
            <a href="javascript:refreshCode();"><img src="${pageContext.request.contextPath}/checkCodeServlet" title="refresh" id="vcode"/></a>
        </div>
        <hr/>
